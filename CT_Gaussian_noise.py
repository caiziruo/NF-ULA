...
if __name__ == "__main__":
    ULA_NF_test = ULA_NF(problem = 'CT_Gaussian_noise', noise_variance = 1, step_size = 1e-6, alpha = 5000.0, sample_size = 11000, figure_name = 'figure1', load_observation = True, projection_C = 100.0, lambda_Moreau = 5e-5)
    ...
    # ULA_NF_test.ULA_NF_CT_sample(start_from = "sample_PnP_ULA.pt", save_samples = False, save_samples_size = 10000, load_pt = pt_NF) # 
    # ULA_NF_test.ULA_NF_CT_sample(start_from = "sample_ULA_NF.pt", save_samples = False, save_samples_size = 10000, load_pt = pt_NF) # 
    # ULA_NF_test.Quantification(samples = 'samples/ULA_NF_Samples.pt', colorbar_range = 0.05, algorithm = 'ULA_NF', network = 'patchNR')


    PnP_ULA_test = ULA_NF(problem = 'CT_Gaussian_noise', noise_variance = 1, step_size = 1e-6, alpha = 3.0, sample_size = 22000, figure_name = 'figure1', load_observation = True, projection_C = 100.0, lambda_Moreau = 5)
    ...
    # PnP_ULA_test.PnP_ULA_CT_sample(start_from = "sample_PnP_ULA.pt", save_samples = False, save_samples_size = 10000, load_pt = pt_PnP) # 
...
# './Provable_Plug_and_Play/training/logs/2023-01-20/DnCNN_Sigma5_17Layers_modeS_LipConst/epoch1_noise5_PSNR37.59_SSIM0.97.pth'
